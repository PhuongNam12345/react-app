        ...
        <div className="content_left">
            ...
            <div className="form">
                ...
                <div className="form-group">
                    ...
                    <input type="text" value={fullname} onChange={(e)=> setUsername(e.target.value)}
                ...
                <div className="login">
                    <input type="submit" onClick={handleRegister} value="Sign up" className="signup" href="asas"></input>
