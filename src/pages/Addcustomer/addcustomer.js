        ...
        <div className="content_left">
            ...
            <div className="form">
                ...
                <div className="form-group">
                    ...
                    <input type="email" name="email" placeholder="youname@gmail.com" value={email} onChange={(e)=>
                    setEmail(e.target.value)}
                    ></input>
                </div>
                <div className="form-group">
                    <label>Phone number</label>
                    <input type="number" name="phone" placeholder="Phone number" value={phone} onChange={(e)=>
                    setPhone(e.target.value)}></input>
                </div>
                <div className="form-group">
                    <label>Address</label>
                    <input type="text" name="address"placeholder="address" value={address} onChange={(e)=>
                ...
                <div >
                    <input type="submit" onClick={handleAdd} value="Add" className="addcustomer" href="asas"></input>
                    {/* <p>
